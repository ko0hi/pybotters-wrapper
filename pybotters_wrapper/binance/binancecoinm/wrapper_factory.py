...
class BinanceCOINMWrapperFactory(WrapperFactory):
    ...
    def create_store_initializer(
        cls, store: BinanceCOINMDataStore = None
    ) -> StoreInitializer:
    ...
    @classmethod
    def create_price_size_precisions_fetcher(cls) -> BinancePriceSizePrecisionFetcher:
        return BinancePriceSizePrecisionFetcher(cls.create_exchange_property().exchange)
