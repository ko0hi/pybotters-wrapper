...
class FetchPositionResponse(NamedTuple):
    positions: list[PositionItem]
    resp: ClientResponse | None = None
    resp_data: dict | None = None


class PositionFetchAPI(FetchAPI):
    def __init__(
        self,
        ...
        | None = None,
        response_converter: Callable[[ClientResponse, any], PositionItem] | None = None,
    ):
    ...
    def fetch_order(
        ...
        return FetchPositionResponse(item, resp, resp_data)
