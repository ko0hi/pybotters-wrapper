...
from typing import Generic, TypeVar, Awaitable, NamedTuple, TypedDict, Optional, Literal
...
import pybotters
from pybotters.store import DataStoreManager, TDataStore
...
class StoreInitializer(Generic[TDataStoreManager], metaclass=ABCMeta):
    ...
    def __init__(
        self, store: TDataStoreManager, config: dict[str, InitializeRequestItem] = None
    ):
        self._store: TDataStoreManager = store
        self._config: dict[str, InitializeRequestItem] = (
